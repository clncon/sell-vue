<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect :select-type="selectType" :only-content="onlyContent" :ratings="ratings" @on-type-select="onTypeSelect" @on-onlyContent-select="onOnlyContentSelect"></ratingselect>
 ...
 .ratings
  ...
  .overview
    ...
    .overview-left
      ...
      text-align: center
      @media only screen and (max-width: 320p)
        flex: 0 0 120px
        width: 120px
      .score
        margin-bottom: 6px
